...
pddl::Atom parse(const domain::ast::AtomicFormulaOfTerms& node, Context& context) { return boost::apply_visitor(AtomicFormulaOfTermsVisitor(context), node); }
...
pddl::Literal parse(const domain::ast::Literal& node, Context& context) { return boost::apply_visitor(LiteralVisitor(context), node); }
