...
#ifndef LOKI_SRC_PDDL_PARSER_DOMAIN_CONSTANTS_HPP_
#define LOKI_SRC_PDDL_PARSER_DOMAIN_CONSTANTS_HPP_
...
public:
    ConstantListVisitor(DomainParsingContext& context_);
...
extern ObjectList parse(const ast::Constants& constants_node, DomainParsingContext& context);
