...
Object parse_object_reference(const ast::Name& name_node, C& context)
{
...
template Object parse_object_reference(const ast::Name& name_node, DomainParsingContext& context);
template Object parse_object_reference(const ast::Name& name_node, ProblemParsingContext& context);

static void insert_context_information(const Object& object, const ast::Name& node, ProblemParsingContext& context)
{
...
static ObjectList parse_object_definitions(const std::vector<ast::Name>& name_nodes, const TypeList& type_list, ProblemParsingContext& context)
{
...
ObjectListVisitor::ObjectListVisitor(ProblemParsingContext& context_) : context(context_) {}
...
ObjectList ObjectListVisitor::operator()(const ast::TypedListOfNamesRecursively& node)
{
    ...
    const auto type_list = boost::apply_visitor(visitor, node.type);
...
ObjectList parse(const ast::Objects& objects_node, ProblemParsingContext& context)
{
