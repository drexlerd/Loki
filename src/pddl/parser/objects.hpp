...
/* Object */
extern pddl::Object parse_object_reference(const ast::Name& name_node, Context& context);

extern pddl::ObjectList parse(const ast::Objects& objects_node, Context& context);
