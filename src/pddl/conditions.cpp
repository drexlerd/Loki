...
void ConditionLiteralImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const { m_literal->str(out, options, typing_enabled); }
...
void ConditionAndImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    out << "(and ";
    for (size_t i = 0; i < m_conditions.size(); ++i)
    {
        if (i != 0)
            out << " ";
        std::visit(StringifyVisitor(out, options, typing_enabled), *m_conditions[i]);
    }
    out << ")";
}
...
void ConditionOrImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    out << "(or ";
    for (size_t i = 0; i < m_conditions.size(); ++i)
    {
...
void ConditionNotImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    out << "(not ";
...
void ConditionImplyImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    out << "(imply ";
    std::visit(StringifyVisitor(out, options, typing_enabled), *m_condition_left);
    out << " ";
    std::visit(StringifyVisitor(out, options, typing_enabled), *m_condition_right);
    out << ")";
}
...
void ConditionExistsImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    out << "(exists (";
...
void ConditionForallImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    out << "(forall (";
    for (size_t i = 0; i < m_parameters.size(); ++i)
    {
