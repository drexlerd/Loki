...
void FunctionExpressionNumberImpl::str(std::ostream& out, const FormattingOptions& /*options*/, bool /*typing_enabled*/) const { out << m_number; }
...
void FunctionExpressionBinaryOperatorImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    out << "(" << to_string(m_binary_operator) << " ";
    std::visit(StringifyVisitor(out, options, typing_enabled), *m_left_function_expression);
    out << " ";
    std::visit(StringifyVisitor(out, options, typing_enabled), *m_right_function_expression);
    out << ")";
}
...
void FunctionExpressionMultiOperatorImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    ...
    {
        out << " ";
        std::visit(StringifyVisitor(out, options, typing_enabled), *function_expression);
    }
    out << ")";
}
...
void FunctionExpressionMinusImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
    out << "(- ";
...
void FunctionExpressionFunctionImpl::str(std::ostream& out, const FormattingOptions& options, bool typing_enabled) const
{
