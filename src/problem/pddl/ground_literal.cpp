...
namespace loki::pddl {
GroundLiteralImpl::GroundLiteralImpl(int identifier, bool is_negated, const GroundAtom& atom)
    : Base(identifier)
...
bool GroundLiteralImpl::are_equal_impl(const GroundLiteralImpl& other) const {
    return (m_is_negated == other.m_is_negated)
        && (m_atom == other.m_atom);
}
