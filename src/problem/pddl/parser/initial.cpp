...
std::vector<std::variant<pddl::GroundLiteral, pddl::NumericFluent>> parse(const problem::ast::Initial& initial_node, Context& context)
{
    auto initial_element_list = std::vector<std::variant<pddl::GroundLiteral, pddl::NumericFluent>>();
...
std::variant<pddl::GroundLiteral, pddl::NumericFluent> parse(const problem::ast::InitialElementLiteral& node, Context& context)
{
    return parse(node.literal, context);
}

std::variant<pddl::GroundLiteral, pddl::NumericFluent> parse(const problem::ast::InitialElementTimedLiterals& /*node*/, Context& /*context*/)
{
    throw NotImplementedError("InitialElementVisitor::operator()(const problem::ast::InitialElementTimedLiterals& node)");
}

std::variant<pddl::GroundLiteral, pddl::NumericFluent> parse(const problem::ast::InitialElementNumericFluentsTotalCost& node, Context& context)
{
...
std::variant<pddl::GroundLiteral, pddl::NumericFluent> parse(const problem::ast::InitialElementNumericFluentsGeneral& node, Context& context)
{
