...
string parse_text(const problem::ast::Atom& node, const FormattingOptions& options) { return parse_text(node.atomic_formula_of_names, options); }
...
string parse_text(const problem::ast::Literal& node, const FormattingOptions& options) { return boost::apply_visitor(NodeVisitorPrinter(options), node); }

string parse_text(const problem::ast::InitialElementLiteral& node, const FormattingOptions& options) { return parse_text(node.literal, options); }
...
string parse_text(const problem::ast::MetricFunctionExpressionNumber& node, const FormattingOptions& options) { return parse_text(node.number, options); }
...
string parse_text(const problem::ast::Optimization& node, const FormattingOptions& options) { return boost::apply_visitor(NodeVisitorPrinter(options), node); }
