...
BOOST_FUSION_ADAPT_STRUCT(loki::problem::ast::BasicFunctionTermArityGreaterZero, function_symbol)
BOOST_FUSION_ADAPT_STRUCT(loki::problem::ast::BasicFunctionTermArityZero, function_symbol, names)
...
BOOST_FUSION_ADAPT_STRUCT(loki::problem::ast::Metric, optimization, metric_function_expression)

BOOST_FUSION_ADAPT_STRUCT(loki::problem::ast::Problem, problem_name, objects, initial, goal, constraints, requirements)
