...
#ifndef LOKI2_FMT_FORMATTER_HPP_
#define LOKI2_FMT_FORMATTER_HPP_
...
#ifndef LOKI2_ENABLE_FMT_FORMATTERS
#define LOKI2_ENABLE_FMT_FORMATTERS 1
#endif

namespace loki2::format
{
...
#if LOKI2_ENABLE_FMT_FORMATTERS
#define LOKI2_DEFINE_AST_FORMATTER(Type, Function) \
    template<> \
...
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::TypeExpression, loki2::format::type_expression)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Term, loki2::format::term)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Atom, loki2::format::atom)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Literal, loki2::format::literal)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::FunctionTerm, loki2::format::function_term)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::FunctionExpression, loki2::format::function_expression)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Condition, loki2::format::condition)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Effect, loki2::format::effect)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::InitialFunctionValue, loki2::format::initial_function_value)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::InitialElement, loki2::format::initial_element)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Action, loki2::format::action)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Axiom, loki2::format::axiom)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Metric, loki2::format::metric)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Domain, loki2::format::domain)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::Task, loki2::format::task)
LOKI2_DEFINE_AST_FORMATTER(loki2::ast::File, loki2::format::file)

#undef LOKI2_DEFINE_AST_FORMATTER
#endif
