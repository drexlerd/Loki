...
#ifndef LOKI2_SEMANTIC_TRANSLATOR_CONDITION_BUILDER_TRANSLATOR_HPP_
#define LOKI2_SEMANTIC_TRANSLATOR_CONDITION_BUILDER_TRANSLATOR_HPP_
...
{
    return this->m_storage->builder.condition(this->m_storage->repository, std::move(value)).get_index();
}
