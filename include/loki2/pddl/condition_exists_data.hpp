...
#ifndef LOKI2_PDDL_CONDITION_EXISTS_DATA_HPP_
#define LOKI2_PDDL_CONDITION_EXISTS_DATA_HPP_
...
template<>
struct Data<::loki2::pddl::ConditionExists>
{
    ygg::Index<::loki2::pddl::ConditionExists> index;
