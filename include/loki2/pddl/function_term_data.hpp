...
#ifndef LOKI2_PDDL_FUNCTION_TERM_DATA_HPP_
#define LOKI2_PDDL_FUNCTION_TERM_DATA_HPP_
...
template<>
struct Data<::loki2::pddl::FunctionTerm>
{
    ygg::Index<::loki2::pddl::FunctionTerm> index;
    ygg::Index<::loki2::pddl::FunctionSkeleton> function;
    ygg::IndexList<::loki2::pddl::Term> terms;

    Data() = default;
    Data(ygg::Index<::loki2::pddl::FunctionSkeleton> function_, ygg::IndexList<::loki2::pddl::Term> terms_ = {}) : index(), function(function_), terms(std::move(terms_)) {}
