...
#ifndef LOKI2_PDDL_EFFECT_ONE_OF_DATA_HPP_
#define LOKI2_PDDL_EFFECT_ONE_OF_DATA_HPP_
...
template<>
struct Data<::loki2::pddl::EffectOneOf>
{
    ygg::Index<::loki2::pddl::EffectOneOf> index;
