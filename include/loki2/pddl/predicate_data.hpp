...
#ifndef LOKI2_PDDL_PREDICATE_DATA_HPP_
#define LOKI2_PDDL_PREDICATE_DATA_HPP_
...
template<>
struct Data<::loki2::pddl::Predicate>
{
    ygg::Index<::loki2::pddl::Predicate> index;
    ::cista::offset::string name;
    ygg::IndexList<::loki2::pddl::Parameter> parameters;

    Data() = default;
    Data(::cista::offset::string name_, ygg::IndexList<::loki2::pddl::Parameter> parameters_ = {}) : index(), name(std::move(name_)), parameters(std::move(parameters_)) {}
