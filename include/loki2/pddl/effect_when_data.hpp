...
#ifndef LOKI2_PDDL_EFFECT_WHEN_DATA_HPP_
#define LOKI2_PDDL_EFFECT_WHEN_DATA_HPP_
...
template<>
struct Data<::loki2::pddl::EffectWhen>
{
    ygg::Index<::loki2::pddl::EffectWhen> index;
    ygg::Index<::loki2::pddl::Condition> condition;
    ygg::Index<::loki2::pddl::Effect> effect;

    Data() = default;
    Data(ygg::Index<::loki2::pddl::Condition> condition_, ygg::Index<::loki2::pddl::Effect> effect_) : index(), condition(condition_), effect(effect_) {}
