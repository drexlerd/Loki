...
#ifndef LOKI2_PDDL_CONDITION_OR_DATA_HPP_
#define LOKI2_PDDL_CONDITION_OR_DATA_HPP_
...
template<>
struct Data<::loki2::pddl::ConditionOr>
{
    ygg::Index<::loki2::pddl::ConditionOr> index;
