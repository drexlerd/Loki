...
#ifndef LOKI2_PDDL_ACTION_VIEW_HPP_
#define LOKI2_PDDL_ACTION_VIEW_HPP_
...
#include "loki2/pddl/action_data.hpp"

namespace ygg
{

template<typename C>
class View<ygg::Index<::loki2::pddl::Action>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki2::pddl::Action> m_handle;

public:
    View(ygg::Index<::loki2::pddl::Action> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
