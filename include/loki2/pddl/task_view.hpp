...
#ifndef LOKI2_PDDL_TASK_VIEW_HPP_
#define LOKI2_PDDL_TASK_VIEW_HPP_
...
#include "loki2/pddl/task_data.hpp"

namespace ygg
{

template<typename C>
class View<ygg::Index<::loki2::pddl::Task>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki2::pddl::Task> m_handle;

public:
    View(ygg::Index<::loki2::pddl::Task> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
