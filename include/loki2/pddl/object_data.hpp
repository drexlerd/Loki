...
#ifndef LOKI2_PDDL_OBJECT_DATA_HPP_
#define LOKI2_PDDL_OBJECT_DATA_HPP_
...
template<>
struct Data<::loki2::pddl::Object>
{
    ygg::Index<::loki2::pddl::Object> index;
    ::cista::offset::string name;
    ygg::IndexList<::loki2::pddl::Type> types;

    Data() = default;
    Data(::cista::offset::string name_, ygg::IndexList<::loki2::pddl::Type> types_ = {}) : index(), name(std::move(name_)), types(std::move(types_)) {}
