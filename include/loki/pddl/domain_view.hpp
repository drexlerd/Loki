...
#ifndef LOKI_PDDL_DOMAIN_VIEW_HPP_
#define LOKI_PDDL_DOMAIN_VIEW_HPP_
...
#include "loki/pddl/domain_data.hpp"

namespace ygg
{

template<typename C>
class View<ygg::Index<::loki::pddl::Domain>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::pddl::Domain> m_handle;

public:
    View(ygg::Index<::loki::pddl::Domain> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
