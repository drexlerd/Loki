...
#ifndef LOKI_PDDL_CONDITION_LITERAL_DATA_HPP_
#define LOKI_PDDL_CONDITION_LITERAL_DATA_HPP_
...
template<>
struct Data<::loki::pddl::ConditionLiteral>
{
    ygg::Index<::loki::pddl::ConditionLiteral> index;
