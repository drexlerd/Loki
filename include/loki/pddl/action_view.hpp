...
#ifndef LOKI_PDDL_ACTION_VIEW_HPP_
#define LOKI_PDDL_ACTION_VIEW_HPP_
...
#include "loki/pddl/action_data.hpp"

namespace ygg
{

template<typename C>
class View<ygg::Index<::loki::pddl::Action>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::pddl::Action> m_handle;

public:
    View(ygg::Index<::loki::pddl::Action> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
