...
#ifndef LOKI_PDDL_CONDITION_NOT_DATA_HPP_
#define LOKI_PDDL_CONDITION_NOT_DATA_HPP_
...
template<>
struct Data<::loki::pddl::ConditionNot>
{
    ygg::Index<::loki::pddl::ConditionNot> index;
    ygg::Index<::loki::pddl::Condition> condition;

    Data() = default;
    Data(ygg::Index<::loki::pddl::Condition> condition_) : index(), condition(condition_) {}
