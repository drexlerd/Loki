...
#ifndef LOKI_PDDL_CONDITION_FORALL_DATA_HPP_
#define LOKI_PDDL_CONDITION_FORALL_DATA_HPP_
...
template<>
struct Data<::loki::pddl::ConditionForall>
{
    ygg::Index<::loki::pddl::ConditionForall> index;
