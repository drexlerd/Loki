...
template<typename C>
class View<ygg::Index<::loki::formalism::UnaryFunctionExpression>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::formalism::UnaryFunctionExpression> m_handle;

public:
    View(ygg::Index<::loki::formalism::UnaryFunctionExpression> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
