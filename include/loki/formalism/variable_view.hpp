...
template<typename C>
class View<ygg::Index<::loki::formalism::Variable>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::formalism::Variable> m_handle;

public:
    View(ygg::Index<::loki::formalism::Variable> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
