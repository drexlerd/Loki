...
template<typename C>
class View<ygg::Index<::loki::formalism::Parameter>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::formalism::Parameter> m_handle;

public:
    View(ygg::Index<::loki::formalism::Parameter> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
