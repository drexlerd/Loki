...
private:
    const C* m_context;
    ygg::Index<::loki::formalism::ConditionNumericConstraint> m_handle;

public:
    View(ygg::Index<::loki::formalism::ConditionNumericConstraint> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
