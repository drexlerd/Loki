...
private:
    const C* m_context;
    ygg::Index<::loki::formalism::FunctionExpressionNumber> m_handle;

public:
    View(ygg::Index<::loki::formalism::FunctionExpressionNumber> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
