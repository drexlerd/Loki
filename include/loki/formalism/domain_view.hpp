...
template<typename C>
class View<ygg::Index<::loki::formalism::Domain>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::formalism::Domain> m_handle;

public:
    View(ygg::Index<::loki::formalism::Domain> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
