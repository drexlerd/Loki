...
template<typename C>
class View<ygg::Index<::loki::formalism::EffectWhen>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::formalism::EffectWhen> m_handle;

public:
    View(ygg::Index<::loki::formalism::EffectWhen> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
