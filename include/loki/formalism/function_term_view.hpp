...
template<typename C>
class View<ygg::Index<::loki::formalism::FunctionTerm>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::formalism::FunctionTerm> m_handle;

public:
    View(ygg::Index<::loki::formalism::FunctionTerm> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
    ...
    auto get_num_terms() const noexcept { return get_data().terms.size(); }
