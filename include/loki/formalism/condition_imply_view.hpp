...
template<typename C>
class View<ygg::Index<::loki::formalism::ConditionImply>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::formalism::ConditionImply> m_handle;

public:
    View(ygg::Index<::loki::formalism::ConditionImply> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
