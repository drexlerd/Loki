...
template<typename C>
class View<ygg::Index<::loki::formalism::Atom>, C>
{
private:
    const C* m_context;
    ygg::Index<::loki::formalism::Atom> m_handle;

public:
    View(ygg::Index<::loki::formalism::Atom> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
