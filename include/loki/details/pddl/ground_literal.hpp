...
#ifndef LOKI_INCLUDE_LOKI_PDDL_GROUND_LITERAL_HPP_
#define LOKI_INCLUDE_LOKI_PDDL_GROUND_LITERAL_HPP_
...
private:
    ...
    friend class PDDLFactory<GroundLiteralImpl, Hash<GroundLiteralImpl*>, EqualTo<GroundLiteralImpl*>>;
