...
using Index = ygg::Index<f::EffectProbabilistic>;
using Data = ygg::Data<f::EffectProbabilistic>;
...
static_assert(std::same_as<View, f::EffectProbabilisticView>);
