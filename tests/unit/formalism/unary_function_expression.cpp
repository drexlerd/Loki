...
using Index = ygg::Index<f::UnaryFunctionExpression>;
using Data = ygg::Data<f::UnaryFunctionExpression>;
...
static_assert(std::same_as<View, f::UnaryFunctionExpressionView>);
